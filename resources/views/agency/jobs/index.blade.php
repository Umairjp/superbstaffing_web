                    ...
                    <div class="card-body">
                        <div class="create-new-job">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="job-status" id="job-status" placeholder="Job Status" class="form-control">
                                        
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" name="start-date" id="start-date" placeholder="Start Date"  class="form-control">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="end-date" id="end-date" placeholder="End Date" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <input type="text" name="timing" id="timing" placeholder="Timing" class="form-control short">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <input type="text" name="hourly-rate" id="hourly-rate"
                                            placeholder="Hourly Rate" class="form-control short">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <input  type="text" name="payment" id="payment"
                                            placeholder="Payments" class="form-control short">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3">
                                    <div class="form-group">
                                        <input class="short form-control" type="text" name="bonus" id="bonus" placeholder="Bonus">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <textarea name="comment" form="usrform" class="form-control mb-4" rows="5">Description</textarea>
